...
//       <Text ><Text style={{fontWeight: 'bold'}}> Document Type:</Text> Passport</Text>
//       <Text > <Text style={{fontWeight: 'bold'}}>Description:</Text>
//         The missing document is a Cameroonian passport  . 
//         It has a blue cover with the Cameroon emblem embossed on the front. The passport number is xxxxxxx, and 
