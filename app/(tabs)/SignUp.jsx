...
import RegValidation from '../../ComponenentsSignUp/RegValidation';
...
const SignUp = () => {
  return (
    <View style={styles.mainSignup}>
      ...
      <Text style={styles.signUpPhrase}>Create account to get started</Text>
      </View>
      ...
      <View style={styles.demacation}>
         ...
         <View style={styles.line2}>
          <Text style={styles.lin2Text}>SignUp With</Text>
         </View >
